...
/// A Jaringan page resolver that implements a simple microblog application.
/// Users can register (getting an auth token) and post messages to a shared feed.
pub struct MicroblogResolver {
